...
@app.cell
def _(Domain, Expr, Model, ObjectiveSense, SolutionStatus, df_prices, pd):
...
@app.cell
def _(compute_inputs, df_prices, list_factors):
    # Number of factors
...
def _(compute_inputs, df_prices, factor_model, fnum):
    ...
    m_F, B, S_F, diag_S_theta = factor_model(m_log, S_log, fnum)
    return B, S_F, diag_S_theta
...
@app.cell
def _(EfficientFrontier, G_factor, G_orig, N, fnum, g_specific, m_orig, np):
    ...
    return df_result_factor, df_result_orig
...
@app.cell
def _(df_result_factor, df_result_orig, plt):
...
@app.cell
def _(LinearSegmentedColormap, df_result_factor, df_result_orig, plt):
