...
def _(compute_inputs, df_prices):
    ...
    return N, S_orig, S_shrunk, m_orig, m_shrunk
...
@app.cell
def _(EfficientFrontier, G_orig, G_shrunk, N, m_orig, m_shrunk, np):
    ...
    return df_result_orig, df_result_shrunk
...
@app.cell
def _(df_result_orig, df_result_shrunk, plt):
...
@app.cell
def _(LinearSegmentedColormap, df_result_orig, df_result_shrunk, plt):
...
def _(np):
    def mean_shrinkage_JS(m_estim, S_estim, return_array):
        ...
        return m_shrunk
    return (mean_shrinkage_JS,)


@app.cell
def _(alpha_numerator, np):
